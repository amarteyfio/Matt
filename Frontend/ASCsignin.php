...
<div class="wrapper">
        ...
        <form action="" method="post" class="p-3 mt-3">
            <div class="form-field d-flex align-items-center" style="text-align:center;">
                ...
                <input type="text" name="id" style="height: 6vh; border-radius: 10px; width: 30vh;" id="userName" placeholder="ID">
            </div>
            <br>
            <div class="form-field d-flex align-items-center" style="text-align:center;">
                <span class="fas fa-key"></span>
                <input type="password" name="password" style="height: 6vh; border-radius: 10px; width: 30vh;" id="pwd" placeholder="Password">
